...
>Let $H$ be an open divisible subgroup of an abelian topological group $G$. Then $G$ is topologically isomorphic to $H\times G/H$. And $G/H$ is a discrete topological group.^[Sidney A. Morris - "Topology without tears" p.531]
